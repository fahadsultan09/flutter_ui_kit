    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          actions: <Widget>[
            IconButton(icon: Icon(Icons.favorite_border,size: screenAwareSize(20.0, context),color: Colors.white,),onPressed: (){}),
          ],
          ),
          body: ListView(
            children: <Widget>[
                ProductScreenUpperPart(),
                ProductScreenLowerPart(),
            ],
          ),
      ),
...
class ProductScreenUpperPart extends StatefulWidget {
  @override
  _ProductScreenUpperPartState createState() => _ProductScreenUpperPartState();
}

class _ProductScreenUpperPartState extends State<ProductScreenUpperPart> {
  @override
  Widget build(BuildContext context) {
    return Container(
      width: double.infinity,
          ...
          Stack(children: <Widget>[
              ...
              Positioned(
                left: screenAwareSize(18.0, context),
                  ...
                  children: <Widget>[
                    Text("Rating",style: TextStyle(color: Colors.grey[200],fontSize: screenAwareSize(18.0, context))),
                    SizedBox(height: screenAwareSize(8.0, context),),
                    Row(
                      children: <Widget>[
                        SizedBox(width: 8.0,),
                        Icon(Icons.star,color: Colors.yellow[500],),
                        SizedBox(width: screenAwareSize(8.0, context),),                        
                        Text("4.5",style: TextStyle(color: Colors.yellow[500]),),
                        SizedBox(width: screenAwareSize(8.0, context),),
                        Text("(422 People)",style: TextStyle(color: Colors.white,fontSize: 14.0),)
...
class ProductScreenLowerPart extends StatefulWidget {
  @override
  _ProductScreenLowerPartState createState() =>
      new _ProductScreenLowerPartState();
}

class _ProductScreenLowerPartState extends State<ProductScreenLowerPart> {
